...
pub fn load_arb_config(config_path: &str) -> anyhow::Result<Config> {
    dotenvy::dotenv().ok();
...
pub fn load_katana_config(config_path: &str) -> anyhow::Result<Config> {
    dotenvy::dotenv().ok();
